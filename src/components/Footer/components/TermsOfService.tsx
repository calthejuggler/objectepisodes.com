				...
				<div
					...
					<div className='modal-content'>
						...
						<div className='modal-body'>
							...
							<p>Welcome to Object Episodes!</p>

							<p>
								These terms and conditions outline the rules and
								regulations for the use of Object Episodes'
								Website, located at https://objectepisodes.com.
							</p>

							<p>
								By accessing this website we assume you accept
								these terms and conditions. Do not continue to
								use Object Episodes if you do not agree to take
								all of the terms and conditions stated on this
								page. Our Terms and Conditions were created with
								the help of the{' '}
							...
							<p>
								...
								Object Episodes, you agreed to use cookies in
								agreement with the Object Episodes' Privacy
								Policy.
							</p>
							...
							<p>
								Unless otherwise stated, Object Episodes and/or
								its licensors own the intellectual property
								rights for all material on Object Episodes. All
								intellectual property rights are reserved. You
								may access this from Object Episodes for your
							...
							<p>You must not:</p>
							<ul>
								<li>Republish material from Object Episodes</li>
								<li>
								...
								<li>
									Redistribute content from Object Episodes
								</li>
							</ul>
							...
							<p>
								...
								Object Episodes does not filter, edit, publish
								or review Comments prior to their presence on
								the website. Comments do not reflect the views
								and opinions of Object Episodes,its agents
								and/or affiliates. Comments reflect the views
								and opinions of the person who post their views
								and opinions. To the extent permitted by
								applicable laws, Object Episodes shall not be
							...
							<p>
								Object Episodes reserves the right to monitor
								all Comments and to remove any Comments which
								can be considered inappropriate, offensive or
							...
							<p>
								You hereby grant Object Episodes a non-exclusive
							...
							<p>
								...
								absence of Object Episodes; and (d) the link is
							...
							<p>
								...
								e-mail to Object Episodes. Please include your
							...
							<p>
								No use of Object Episodes' logo or other
